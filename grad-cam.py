...
# parameters_1 = torch.load('./resnet_model/pgdtraining_poch10.pth')
# resnet.load_state_dict(parameters_1)
...
if __name__ == '__main__':
	...
	# parameter_2 = torch.load('./resnet_model/pgdtraining_poch10.pth')
	# model.load_state_dict(parameter_2)
